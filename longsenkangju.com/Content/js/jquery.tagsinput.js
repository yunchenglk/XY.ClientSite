...
(function($) {
  ...
  $.fn.resetAutosize = function(options){
	...
	$.fn.addTag = function(value,options) {
			...
			this.each(function() {
				var id = $(this).attr('id');
				var tagslist = $(this).val().split(_delimiter);
				if (tagslist[0] == '') {
					tagslist = new Array();
				}
	...
	$.fn.removeTag = function(value) {
			...
			this.each(function() {
				...
				var old = $(this).val().split(_delimiter);

				$('#'+id+'_tagsinput .tag').remove();
				str = '';
				for (i=0; i< old.length; i++) {
					if (old[i]!=value) {
						str = str + _delimiter +old[i];
					}
				}
	...
	$.fn.tagsInput.updateTagsField = function(obj,tagslist) {
		var id = $(obj).attr('id');
		$(obj).val(tagslist.join(_delimiter));
	};

	$.fn.tagsInput.importTags = function(obj,val) {
		$(obj).val('');
		var id = $(obj).attr('id');
		var tags = val.split(_delimiter);
